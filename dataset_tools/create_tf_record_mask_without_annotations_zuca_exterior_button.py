...
# buttons limits
lower_ext = np.array([20, 245, 215])
upper_ext = np.array([40, 265, 295])
...
def reset_counters():
  global contador_exterior
  contador_exterior = 0


def count_element(class_name):
  global contador_exterior
  if class_name == 'exterior':
    contador_exterior += 1
...
def print_counters(section):
  ...
  print('*********************** ' + section + ' ***********************')
  print('****************************************************')
  print('exterior tiene {} elementos'.format(contador_exterior))
  print('****************************************************')
  print('****************************************************')
  print('****************************************************')
...
def get_limits(index):
  if index == 0:
    lower_color = lower_ext
    upper_color = upper_ext
...
def analize_mask(img):
  ...
  for index, button in enumerate(buttons):
    ...
    if len(contours) > 0:
      print('--button ' + button + ' has {} contours'.format(len(contours)))
  ...
  return bndboxes, masks, buttons_list
...
def dict_to_tf_example(filename,
  ...
  print('--bndboxes length is {}, masks length is {} and buttons_list length is {}'.format(len(bndboxes), len(masks), len(buttons_list)))  
